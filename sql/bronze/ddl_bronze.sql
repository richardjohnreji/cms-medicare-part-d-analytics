CREATE TABLE bronze.medicare_part_d_prescribers
(
    ...
    Prscrbr_State_Abrvtn     VARCHAR(10)     NULL,
    Prscrbr_State_FIPS       VARCHAR(10)     NULL,
    ...
    GE65_Sprsn_Flag          VARCHAR(10)     NULL,
    ...
    GE65_Bene_Sprsn_Flag     VARCHAR(10)     NULL,
